      ...
      <Box>
        <Cover>
          ...
          <Ul>
            ...
            <LIState>
              <PState>
                상태<span style={{ color: "rgb(255, 80, 88)" }}>*</span>
              </PState>
              <DivState>
                <StateInput
                  type="checkbox"
            ...
            <LIChange>
              <PChange>
                교환<span style={{ color: "rgb(255, 80, 88)" }}>*</span>
              </PChange>
              <DivChange>
                <ChangeInput
                  type="checkbox"
            ...
            <LiPrice>
              <PTitle>
                가격<span style={{ color: "rgb(255, 80, 88)" }}>*</span>
              </PTitle>
              <DivPri>
                <InputPri
                  type="number"
            ...
            <LiContent>
              ...
              <DivCont>
                ...
                <ContBottom>
                  <span>
                    혹시{" "}
                    <a href="https://m.bunjang.co.kr/customer/notice?id=607">
                      카카오톡 ID
                    </a>
                    를 적으셨나요?
                  </span>
...
`;
>>>>>>> 31cc74864d98520c929fcd388b6c3e0f4ab034ac
